...
public final class ConstantMsgs {
    ...
    public static final String SIGNUP_USER_EXISTING_ERR ="UserModel name exists, Please try a different user name";
    ...
    public static final String NOTE_ERR_CREATION_FAILURE="Creating NoteModel failed, please try later";
    public static final String NOTE_ERR_UPDATE_FAILURE="Updating NoteModel failed, please try later";
    public static final String NOTE_DELETE_ERR="Deleting NoteModel failed, please try later";
    public static final String NOTE_NEW_SUCCESS="New note added successfully";
    public static final String NOTE_EDIT_SUCCESS="NoteModel edit was successful";
    public static final String NOTE_DELETE_SUCCESS="NoteModel deleted successfully";
