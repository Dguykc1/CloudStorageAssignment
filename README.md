...
The home page is the center of the application and hosts the three required pieces of functionality. The existing template presents them as three tabs that can be clicked through by the userModel:
 ...
 i. Files
  ...
  - Any errors related to file actions should be displayed. For example, a userModel should not be able to upload two files with the same name, but they'll never know unless you tell them!
 ...
 - The userModel should be able to view/edit or delete individual credentials. When the userModel views the credential, they should be able to see the unencrypted password.
